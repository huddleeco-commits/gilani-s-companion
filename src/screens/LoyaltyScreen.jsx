...
const REWARDS = [
  { id: 1, name: 'Free Appetizer', points: 500, description: 'Any starter from our menu', available: true },
  { id: 2, name: 'Free Dessert', points: 750, description: 'Chef\'s selection dessert', available: true },
  { id: 3, name: '$25 Off', points: 1500, description: 'On orders $75+', available: true },
  { id: 4, name: 'Free Entrée', points: 3000, description: 'Up to $50 value', available: false },
  { id: 5, name: 'Private Dining', points: 5000, description: 'Exclusive chef\'s table experience', available: false },
];
...
export function LoyaltyScreen() {
  ...
  const currentPoints = user?.points || 2500;
  ...
  return (
    <div className="screen">
      ...
      <div className="card" style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
          ...
          <div style={{
            ...
            <Trophy size={16} />
            <span style={{ fontWeight: '600' }}>{currentTier}</span>
          </div>
        </div>
      ...
      <h3 style={{ fontSize: '14px', fontWeight: '600', marginBottom: '12px', color: 'rgba(255,255,255,0.6)' }}>
        YOUR {currentTier.toUpperCase()} PERKS
      </h3>
