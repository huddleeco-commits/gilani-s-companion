...
export function ProfileScreen() {
  ...
  return (
    <div className="screen">
      {/* Profile Header */}
      <div style={{
        background: 'linear-gradient(180deg, rgba(196, 163, 90, 0.15) 0%, transparent 100%)',
        margin: '-20px -20px 0',
        ...
        <div style={{ padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)' }}>{BUSINESS_NAME} - Oak Lawn</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)' }}>Ribeye Steak, Medium Rare</div>
            </div>
          </div>
        </div>
      </div>
